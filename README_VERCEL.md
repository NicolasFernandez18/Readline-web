...
El archivo `vercel.json` ya incluye estos valores y la regla necesaria para que funcionen las rutas internas de React, por ejemplo `/servicios`, `/precios` y `/contacto`.
